...
import { Link,Redirect } from 'react-router-dom'
 ...
 class Electrician extends Component {
    ...
    render() {
        ...
        const providers=this.props.providers.length!=0?this.props.providers.profiles.filter(item=>item.status=="accepted" && item.category=="electrician"):""
        return (
            <>
              <ProfilePageHeader/>  
...
const  mapStateToProps = (state) => ({
  ...
  export default connect(mapStateToProps,{FetchProviders})( Electrician);
